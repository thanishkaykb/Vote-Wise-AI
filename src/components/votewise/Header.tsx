...
export const Header = ({ eli15, setEli15 }: Props) => {
  return (
    <header className="sticky top-0 z-40 bg-paper/80 backdrop-blur border-b-2 border-ink">
      <div className="container flex items-center justify-between py-3">
        <a href="/" className="flex items-center gap-2 group">
          <div className="w-9 h-9 bg-lime border-2 border-ink rounded-xl flex items-center justify-center shadow-brutal-sm group-hover:rotate-[-6deg] transition-transform">
            <Vote className="w-5 h-5 text-ink" strokeWidth={2.5} />
          </div>
          <div className="leading-none">
            <div className="font-display font-bold text-lg tracking-tight">VoteWise<span className="text-lime-deep">.AI</span></div>
